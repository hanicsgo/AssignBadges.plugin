 ...
 * @author QWERT, hani from anhemyenbai
...
const config = {
	"info": {
		...
		"description": "Allows you to locally assign badges to users through the user context menu.",
		"authors": [{
			"name": "QWERT, hani from anhemyenbai",
			"discord_id": "678556376640913408, 498819334504710165",
			"github_username": "QWERTxD, hani from anhemyenbai"
		}],
